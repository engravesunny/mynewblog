<template>
    <!-- 右侧展示区 -->
        <el-card :class="{'right-sidebar':$route.path==='/home'&&!isFixed,'right-sidebar-fixed':$route.path!=='/home'||isFixed}" body-style="padding:0">
            <el-card style="width:96%;height:620px;margin-left:30px;box-shadow:none;border:0;border-radius:30px;overflow-y:auto;background:rgba(255,255, 255, 0)" body-style="padding:0">
                ...
                <el-card style="width:99%;border-radius:30px;margin-bottom:15px">
                    <el-row type="flex" justify="center" align="center" >
                        <el-image :src="imgSrc" fit="cover" style="margin-bottom:5px;width:100px;height:100px;border-radius:50%"></el-image>
                    </el-row>
                    ...
                    <el-row type="flex" justify="center">
                        <el-col :span="8" style="width:100%">
                            <div style="width:100%;text-align:center" >11</div>
                        </el-col>
                        <el-col :span="8" style="width:100%">
                            <div style="width:100%;text-align:center;border-left:1px solid black;border-right:1px solid black" >13</div>
                        </el-col>
                        <el-col :span="8" style="width:100%">
                    ...
                    <el-row type="flex" justify="center">
                        <el-col :span="12">
                            <div style="width:100%;text-align:center" >
                                <el-button type="text" :class="{active: active }" @click="active=false">文章目录</el-button>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div style="width:100%;text-align:center" >
