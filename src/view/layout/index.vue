<template>
    <div class="layout-container">
            ...
            <el-row type="flex" justify="space-between" >
                <el-row type="flex" justify="start" align="middle">
                    ...
                    <el-col style="width:300px" >
                        <span style="font-weight:800;font-size:larger" >一个简单的博客网站</span>
                    </el-col>
                </el-row>
        ...
        <!-- 子路由出口 -->
        <el-row type="flex" justify="center" style="width:65%;margin:20px auto 0">
            <div>
                <router-view></router-view>
            </div>
            <el-col v-if="isFixed&&showRightSidebar||$route.path!=='/home'" :span="6" style="width:16vw">
            ...
            <el-col :span="6">
                <right-sidebar :isFixed="isFixed" v-if="showRightSidebar"></right-sidebar>
            </el-col>
        </el-row>
...
export default {
    ...
    methods:{
        scroll(){
            ...
            if(window.scrollY>=window.innerHeight-38){
                this.isFixed = true
            } else {
                this.isFixed = false
            }
